...
if ['solo', 'util'].include?(node[:instance_role])
  ...
  workers = %w{emailp1 emailp1 fileprocessingp2,emailp1 fileprocessingp2,emailp1 emailp3,emailp1 backgroundp4,backgroundp5 backgroundp5,backgroundp6 longjobsp7}
